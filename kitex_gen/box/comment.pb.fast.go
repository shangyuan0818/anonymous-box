...
func (x *Comment) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.WebsiteKey, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
func (x *Comment) fastWriteField2(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 2, x.GetWebsiteKey())
	return offset
}
...
func (x *ListCommentsRequest) fastWriteField1(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 1, x.GetWebsiteKey())
	return offset
}
...
func (x *Comment) sizeField2() (n int) {
	...
	n += fastpb.SizeString(2, x.GetWebsiteKey())
	return n
}
...
func (x *ListCommentsRequest) sizeField1() (n int) {
	...
	n += fastpb.SizeString(1, x.GetWebsiteKey())
	return n
}
