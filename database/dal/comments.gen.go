...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.WebsiteRefer = field.NewUint64(tableName, "website_refer")
	_comment.SenderIP = field.NewField(tableName, "sender_ip")
	_comment.Name = field.NewField(tableName, "name")
	_comment.Email = field.NewField(tableName, "email")
	_comment.Url = field.NewField(tableName, "url")
...
type comment struct {
	...
	WebsiteRefer field.Uint64
	SenderIP     field.Field
	Name         field.Field
	Email        field.Field
	Url          field.Field
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.WebsiteRefer = field.NewUint64(table, "website_refer")
	c.SenderIP = field.NewField(table, "sender_ip")
	c.Name = field.NewField(table, "name")
	c.Email = field.NewField(table, "email")
	c.Url = field.NewField(table, "url")
...
func (c *comment) fillFieldMap() {
	...
	c.fieldMap["website_refer"] = c.WebsiteRefer
	c.fieldMap["sender_ip"] = c.SenderIP
