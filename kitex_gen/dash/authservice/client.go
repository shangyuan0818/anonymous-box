...
type Client interface {
	...
	GetServerAuthData(ctx context.Context, Req *dash.AuthToken, callOptions ...callopt.Option) (r *dash.ServerAuthDataResponse, err error)
}
...
func (p *kAuthServiceClient) ChangePassword(ctx context.Context, Req *dash.ChangePasswordRequest, callOptions ...callopt.Option) (r *dash.AuthToken, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.ChangePassword(ctx, Req)
}

func (p *kAuthServiceClient) ResetPassword(ctx context.Context, Req *dash.ResetPasswordRequest, callOptions ...callopt.Option) (r *dash.AuthToken, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.ResetPassword(ctx, Req)
}

func (p *kAuthServiceClient) GetServerAuthData(ctx context.Context, Req *dash.AuthToken, callOptions ...callopt.Option) (r *dash.ServerAuthDataResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
