...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	handlerType := (*api.WebsiteService)(nil)
...
func createWebsiteHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(api.CreateWebsiteRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(api.WebsiteService).CreateWebsite(ctx, req)
		if err != nil {
			return err
		}
	...
	case *CreateWebsiteArgs:
		success, err := handler.(api.WebsiteService).CreateWebsite(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *CreateWebsiteArgs) Unmarshal(in []byte) error {
	msg := new(api.CreateWebsiteRequest)
...
var CreateWebsiteArgs_Req_DEFAULT *api.CreateWebsiteRequest

func (p *CreateWebsiteArgs) GetReq() *api.CreateWebsiteRequest {
	if !p.IsSetReq() {
...
type CreateWebsiteResult struct {
	Success *api.CreateWebsiteResponse
}

var CreateWebsiteResult_Success_DEFAULT *api.CreateWebsiteResponse

func (p *CreateWebsiteResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(api.CreateWebsiteResponse)
	}
...
func (p *CreateWebsiteResult) Unmarshal(in []byte) error {
	msg := new(api.CreateWebsiteResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *CreateWebsiteResult) GetSuccess() *api.CreateWebsiteResponse {
	if !p.IsSetSuccess() {
...
func (p *CreateWebsiteResult) SetSuccess(x interface{}) {
	p.Success = x.(*api.CreateWebsiteResponse)
}
...
func getWebsiteHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(api.WebsiteService).GetWebsite(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetWebsiteArgs:
		success, err := handler.(api.WebsiteService).GetWebsite(ctx, s.Req)
		if err != nil {
			return err
		}
...
func updateWebsiteHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(api.UpdateWebsiteRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(api.WebsiteService).UpdateWebsite(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *UpdateWebsiteArgs:
		success, err := handler.(api.WebsiteService).UpdateWebsite(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *UpdateWebsiteArgs) Unmarshal(in []byte) error {
	msg := new(api.UpdateWebsiteRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var UpdateWebsiteArgs_Req_DEFAULT *api.UpdateWebsiteRequest

func (p *UpdateWebsiteArgs) GetReq() *api.UpdateWebsiteRequest {
	if !p.IsSetReq() {
...
func listWebsitesHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(api.ListWebsitesRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(api.WebsiteService).ListWebsites(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *ListWebsitesArgs:
		success, err := handler.(api.WebsiteService).ListWebsites(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *ListWebsitesArgs) Unmarshal(in []byte) error {
	msg := new(api.ListWebsitesRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var ListWebsitesArgs_Req_DEFAULT *api.ListWebsitesRequest

func (p *ListWebsitesArgs) GetReq() *api.ListWebsitesRequest {
	if !p.IsSetReq() {
...
type ListWebsitesResult struct {
	Success *api.ListWebsitesResponse
}

var ListWebsitesResult_Success_DEFAULT *api.ListWebsitesResponse

func (p *ListWebsitesResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(api.ListWebsitesResponse)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *ListWebsitesResult) Unmarshal(in []byte) error {
	msg := new(api.ListWebsitesResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *ListWebsitesResult) GetSuccess() *api.ListWebsitesResponse {
	if !p.IsSetSuccess() {
...
func (p *ListWebsitesResult) SetSuccess(x interface{}) {
	p.Success = x.(*api.ListWebsitesResponse)
}
...
func (p *kClient) CreateWebsite(ctx context.Context, Req *api.CreateWebsiteRequest) (r *api.CreateWebsiteResponse, err error) {
...
func (p *kClient) UpdateWebsite(ctx context.Context, Req *api.UpdateWebsiteRequest) (r *base.Empty, err error) {
...
func (p *kClient) ListWebsites(ctx context.Context, Req *api.ListWebsitesRequest) (r *api.ListWebsitesResponse, err error) {
